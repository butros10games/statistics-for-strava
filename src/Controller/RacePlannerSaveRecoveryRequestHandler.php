...
#[AsController]
final readonly class RacePlannerSaveRecoveryRequestHandler
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $saveSummary = $this->racePlannerRecoveryManager->save($targetRace, $now);
        if ($saveSummary->hasAnythingToSave()) {
