...
final readonly class Calendar
{
     ...
     */
    private function __construct(private Month $month, private EnrichedActivities $enrichedActivities, private array $plannedSessionsByDay, private array $raceEventsByDay, private array $trainingBlocksByDay)
    {
    }
