...
final readonly class Day
{
     ...
     */
    private function __construct(private SerializableDateTime $date, private int $dayNumber, private bool $isCurrentMonth, private Activities $activities, private array $plannedSessions, private array $raceEvents, private array $trainingBlocks)
    {
    }
