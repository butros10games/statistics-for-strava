...
export function AppShell({
    ...
    const legacyLinks = [
        ...
        {href: buildAppPath(bootstrap.basePath, 'monthly-stats'), label: 'Legacy monthly stats'},
        {href: buildAppPath(bootstrap.basePath, 'photos'), label: 'Legacy photos'},
        {href: buildAppPath(bootstrap.basePath, 'race-event?redirectTo=/race-planner'), label: 'Legacy race-event modal'},
